    ...
    <div className=' mx-auto '>
      <div className='rounded-lg justify-center overflow-auto container pt-15 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center xl:mt-20 xl:pt-0'>
        <div className='flex flex-col w-1/2 h-full xl:w-full self-center lg:items-start  lg:self-center'>
          ...
          <p className='self-center font-medium tracking-widest h-full my-5 text-3xl md:text-5xl  leading-tight text-center md:text-center slide-in-bottom-h1 '>
            xyme
          </p>
          <p className=' self-center mt-20 opacity-0 lg:opacity-1 leading-normal text-base md:text-2xl mb-8 text-center md:text-center slide-in-bottom-subtitle '>
        ...
        >
          ...
          <div className='flex items-center flex-wrap mb-20 border-t-2 border-gray-500 dark:border-t-1 dark:border-gray-200'>
            <motion.div
              ref={ref}
              animate={animation}
              className='w-full md:w-1/2'
            >
              <h4 className='fadeIn mt-20 text-lg md:text-3xl font-bold leading-tight tracking-wider   md:text-left text-gray-800 mb-8 dark:text-gray-400'>
                Check Interactions
              </h4>
          ...
          <div className='flex items-center flex-wrap mb-20'>
            ...
            <motion.div
              ...
              className='w-full md:w-1/2'
            >
              <h4 className=' text-lg md:text-3xl font-bold leading-tight tracking-wider   md:text-left text-gray-800 mb-8 dark:text-gray-400'>
          ...
          <div className='flex items-center flex-wrap mb-20 '>
            ...
            <div className=' flex justify-center fadeIn w-full xs:w-1/2 md:w-1/2 p-10 sm:p-20 md:p-30 ml-30 '>
              <img src='/iphone.svg' alt='Monitoring' />
            </div>
          </div>
        </section>
        ...
        <div className='   w-full pt-16 pb-6 text-sm text-center md:text-left fade-in dark:border-t-2 dark:border-gray-200 border-t-2 border-gray-500'>
          <a
