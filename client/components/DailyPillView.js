        ...
        <div className="flex flex-col">
          {pills === undefined ? (
            ...
            <>
              ...
              <div className="border-8 border-yellow-0 rounded shadow-2x1 fount-mono text-9x1 text-white grid grid-cols-2 gap-x-px">
                {/* left side */}
