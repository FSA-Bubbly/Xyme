      ...
      {isLoading ? (
        ...
        <div className='flex flex-col  '>
          <div className='flex self-center flex-col fadeIn w-full sm:1/2 md:w-1/2 p-20 sm:p-10 md:p-10 overflow-hidden'>
            <h3 className='tracking-widest self font-sans uppercase fadeIn p-2 md:text-2xl  text-xl text-center text-gray-800 dark:text-gray-200 text-gray-800  '>
              profile
            </h3>
          </div>
          <div className='flex items-center justify-center '>
            <div className='bg-white w-full  xs:1/3 sm:w-1/3 md:w-1/3 lg:w-1/3 mt-10 rounded-lg dark:bg-gray-200'>
              <div className='flex items-center justify-center pt-10 flex-col'>
                ...
                <h1 className='text-gray-800 font-normal text-xl mt-5'>
                  {updatedUser.firstName} {updatedUser.lastName}
                </h1>
                <h1 className='text-gray-500 text-sm'></h1>
                <h1 className='px-1 text-xs text-gray-500  p-4 text-left'>
                  <p className='my-1'>Age: {updatedUser.age}</p>
                  <p className='my-1'>Height: {updatedUser.height}</p>
                  <p className='my-1'>Weight: {updatedUser.weight}</p>
                  <p className='my-1'>Email: {updatedUser.email}</p>
                  {/* <p>
